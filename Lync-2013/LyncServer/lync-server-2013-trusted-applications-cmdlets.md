...
description: 'Lync Server 2013 : cmdlets d’applications de confiance.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
---
# <a name="trusted-applications-cmdlets-in-lync-server-2013"></a>Cmdlets d’applications de confiance dans Lync Server 2013
...
## <a name="trusted-applications-cmdlets"></a>Cmdlets d’applications de confiance

Utilisez les applets de commande suivantes pour gérer des applications approuvées.

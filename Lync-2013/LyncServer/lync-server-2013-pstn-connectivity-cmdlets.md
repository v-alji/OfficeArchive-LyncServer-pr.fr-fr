---
title: 'Lync Server 2013 : applets de connexion RTC'
description: 'Lync Server 2013 : applets de connexion RTC.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "49394605"
---
# <a name="pstn-connectivity-cmdlets-in-lync-server-2013"></a>Applets de connexion RTC dans Lync Server 2013
...
Voix entreprise fournit des paramètres qui autorisent les appels vers et à partir du réseau téléphonique commuté (PSTN) sans aucun déclin dans la qualité de service (QoS). Vous pouvez configurer ces paramètres à l’aide de cmdlets disponibles sur Lync Server Management Shell.

<div>

## <a name="pstn-connectivity-cmdlets"></a>Applets de connexion RTC

Utilisez les applets de commande suivantes pour configurer différents aspects de la connectivité PSTN.

**[Applets de applet passerelles RTC dans Lync Server 2013](lync-server-2013-pstn-gateways-cmdlets.md)**
...
**[Cmdlets de routage statique dans Lync Server 2013](lync-server-2013-static-routing-cmdlets.md)**
...
**[Applets de configuration de Trunking dans Lync Server 2013](lync-server-2013-trunking-configuration-cmdlets.md)**

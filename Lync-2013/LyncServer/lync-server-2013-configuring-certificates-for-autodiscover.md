...
12. S’il s’agit d’un service de découverte automatique, c’est-à-dire le lyncdiscover. \> nom \> de domaine et lyncdiscoverinternal.\<domain name\> (selon s’il s’agit d’un certificat interne ou externe), le nom de l’autre personne est manquant et vous utilisez un certificat par défaut unique pour les types par défaut WebServicesInternal et WebServiceExternal, procédez comme suit :

...
Par exemple, si vous avez enregistré les données dans un fichier nommé C : \\ Data \\ Response \_ Group \_ \_ \_Report.csv, vous pouvez utiliser la commande suivante pour renvoyer le nombre total d’appels reçus pour chaque flux de travail répertorié dans le rapport :

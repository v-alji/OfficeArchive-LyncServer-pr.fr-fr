...
---
# <a name="useragentdef-table-qoe-in-lync-server-2013"></a>UserAgentDef table (QoE) dans Lync Server 2013
...
La table UserAgentDef mappe les identificateurs d’agent utilisateur aux noms descriptifs de l’agent. Les agents utilisateurs sont utilisés pour se connecter à Microsoft Lync Server 2013.

...
<span data-ttu-id="062ec-129">Exemple de document de réponse de découverte automatique :</span><span class="sxs-lookup"><span data-stu-id="062ec-129">An example of an Autodiscover Response document:</span></span>

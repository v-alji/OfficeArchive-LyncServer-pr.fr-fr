...
Si Test-CsPstnOutboundCall échoue, vous souhaiterez peut-être réexécuter le test, cette fois-ci, y compris le paramètre Verbose :
...
Voici quelques raisons courantes pour lesquelles Test-CsPstnOutboundCall risque d’échouer :

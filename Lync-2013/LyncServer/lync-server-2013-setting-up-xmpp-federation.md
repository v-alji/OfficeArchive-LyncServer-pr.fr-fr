...
10. Dans la page fichier de demande de certificat, tapez le chemin d’accès complet et le nom du fichier dans lequel la demande doit être enregistrée (par exemple, c : \\ CERT \_ l' \_ Edge. cer).
...
16. Dans la page Configuration du protocole SIP sur le nom de l’objet, activez la case à cocher Domain pour ajouter un SIP.\<sipdomain\> entrée de la liste autres noms d’objet.

...
Le mode SessionDetails stocke les informations sur les sessions d’égal à égal, qui peuvent être un appel téléphonique VoIP-VoIP, une session de messagerie instantanée à deux participants ou un autre type de session. Cet affichage a été présenté dans Microsoft Lync Server 2013.

...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Configuration système requise pour Lync Server 2013](lync-server-2013-system-requirements.md)

  - [Préparation de l’infrastructure et des systèmes pour Lync Server 2013](lync-server-2013-preparing-the-infrastructure-and-systems.md)

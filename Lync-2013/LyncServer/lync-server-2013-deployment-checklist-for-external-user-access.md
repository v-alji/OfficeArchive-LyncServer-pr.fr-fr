...
<td><ul>
<li><p>Configurez le proxy inverse (par exemple, dans le cas de la passerelle de gestion de Threats 2010 ou Microsoft Internet Security and Acceleration (ISA) Server avec Service Pack 1) dans le réseau de périmètre, obtenez les certificats publics nécessaires et configurez les règles de publication Web sur le serveur proxy inverse.</p>

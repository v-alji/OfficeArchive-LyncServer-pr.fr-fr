...
---
# <a name="deploying-lync-for-windows-phone-in-lync-server-2013"></a>Déploiement de Lync pour Windows Phone dans Lync Server 2013
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Installation de Lync pour Windows Phone dans Lync Server 2013](lync-server-2013-installing-lync-for-windows-phone.md)

  - [Suppression de Lync pour Windows Phone dans Lync Server 2013](lync-server-2013-removing-lync-for-windows-phone.md)

...
2.  Tapez ce qui suit dans une invite de ligne de commande :
    ...
    <td><p>Termes de recherche définis pour la configuration. Office 365 ou Microsoft 365, et non des déploiements sur site.</p></td>
    </tr>
    <tr class="even">
    ...
    <td><p>La version minimale du CLSAgent dont lʼexécution est autorisée. Cet élément est destiné à Office 365 ou Microsoft 365.</p></td>
    </tr>
    </tbody>
    </table>

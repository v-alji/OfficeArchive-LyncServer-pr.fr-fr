...
---
# <a name="planning-for-and-configuring-ipv6-in-lync-server-2013"></a>Planification et configuration du protocole IPv6 dans Lync Server 2013
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Configurer les types d’adresses IP dans Lync Server 2013](lync-server-2013-configure-ip-address-types.md)

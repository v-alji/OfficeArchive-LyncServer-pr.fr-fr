...
Pour plus d’informations sur la configuration automatique des clients exécutant Lync 2013 si le DNS avec fractionnement Brain n’est pas configuré, voir la section « Configuration automatique sans Split-Brain DNS » dans [déterminer les exigences DNS pour Lync Server 2013](lync-server-2013-determine-dns-requirements.md).

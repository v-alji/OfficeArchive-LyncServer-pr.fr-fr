...
---
# <a name="call-admission-control-cmdlets-in-lync-server-2013"></a>Applets de commande de contrôle d’admission des appels dans Lync Server 2013
...
Le contrôle d’admission des appels (CAC) détermine s’il existe suffisamment de bande passante réseau pour établir une session de qualité audio ou vidéo en temps réel. Vous pouvez gérer CAC par configuraing limitations et paramètres pour les réseaux, sites et sous-réseaux ainsi que les interactions entre eux.

<div>

## <a name="call-admission-control-cmdlets"></a>Applets de commande de contrôle d’admission des appels

Utilisez les applets de commande suivantes pour gérer CAC à partir de Lync Server Management Shell.

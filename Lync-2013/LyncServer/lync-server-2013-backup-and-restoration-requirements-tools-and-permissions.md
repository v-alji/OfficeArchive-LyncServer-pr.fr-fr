...
<td><p>Procédures de sauvegarde SQL Server ou Export-CsPersistentChatData. Export-CsPersistentChatData exporter les données d’une conversation permanente sous forme de fichier.</p></td>
</tr>
<tr class="odd">
...
> [!NOTE]  
> Situés dans le dossier d’installation ou le média de Lync Server sur \setup\amd64\Setup.exe.
...
<td><p>Procédures de restauration SQL Server ou Import-CsPersistentChatData. Vous pouvez utiliser des Import-CsPersistentChatData avec un fichier créé par Export-CsPersistentChatData et les données seront importées dans la base de données de chat persistant.</p></td>
</tr>
</tbody>
</table>

...
L’outil de personnalisation Office fait partie du programme d’installation et est inclus dans les versions de licence en volume du produit. Vous exécutez l’outil OCT en tapant `setup.exe /admin` à partir de la ligne de commande à partir de la racine du point d’installation réseau qui contient les fichiers source d’Office 2013. Par exemple, utilisez la commande suivante :
...
Pour plus d’informations sur le PTOM, voir <https://go.microsoft.com/fwlink/p/?linkid=267516> .

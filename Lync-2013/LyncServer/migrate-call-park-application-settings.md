...
Lorsque tous les fichiers audio personnalisés ont été copiés sur le magasin de fichiers 2013 de Lync Server, les paramètres de l’application Park du serveur Lync Server 2013 doivent être configurés et les plages d’orbites du parc d’appels associées au pool Lync Server 2010 doivent être réaffectées au pool Lync Server 2013.

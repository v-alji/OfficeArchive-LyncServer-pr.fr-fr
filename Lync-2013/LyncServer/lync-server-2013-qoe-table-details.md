...
Les sections suivantes décrivent en détail les colonnes dans chaque table de schéma de la base de données de qualité de l’interface (QoE).
  ...
  - [Table CodecDescription dans Lync Server 2013](lync-server-2013-codecdescription-table.md)

  - [Table Conference dans Lync Server 2013](lync-server-2013-conference-table.md)

  - [Table Device dans Lync Server 2013](lync-server-2013-device-table.md)

  - [Table DeviceDriver dans Lync Server 2013](lync-server-2013-devicedriver-table.md)

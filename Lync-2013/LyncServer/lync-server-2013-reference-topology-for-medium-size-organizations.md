...
![Diagramme de topologie de référence pour un seul centre de données](images/Gg425939.12b574fd-0b14-4563-a88c-3c8b0809bb90(OCS.15).jpg "Diagramme de topologie de référence pour un seul centre de données")
  ...
  - **La récupération d’urgence peut être ajoutée.**   Pour cette organisation, il est nécessaire de disposer d’une haute disponibilité pour les services Lync Server, mais pas de la reprise après sinistre. La réserve de serveurs frontaux déployés offre une disponibilité élevée.

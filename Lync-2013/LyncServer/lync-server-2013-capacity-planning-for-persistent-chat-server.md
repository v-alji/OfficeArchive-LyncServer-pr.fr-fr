...
Pour télécharger le serveur Chat permanent, voir « Microsoft Lync Server 13 persistent Chat Server » à l’adresse [https://go.microsoft.com/fwlink/p/?linkId=209539](https://go.microsoft.com/fwlink/p/?linkid=209539) .
...
## <a name="single-server-topology"></a>Topologie de Single-Server
...
## <a name="multiple-server-topology"></a>Topologie de Multiple-Server

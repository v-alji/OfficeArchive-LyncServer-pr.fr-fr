...
---
# <a name="server-roles-and-services-cmdlets-in-lync-server-2013"></a>Applets de service et rôles de serveur dans Lync Server 2013
...
**[Cmdlets d’archivage et de surveillance dans Lync Server 2013](lync-server-2013-archiving-and-monitoring-cmdlets.md)**
...
**[Cmdlets de base de données et de serveur de gestion dans Lync Server 2013](lync-server-2013-database-and-management-server-cmdlets.md)**
...
**[Cmdlets du serveur Edge dans Lync Server 2013](lync-server-2013-edge-server-cmdlets.md)**
...
**[Autres cmdlets de rôle de serveur dans Lync Server 2013](lync-server-2013-other-server-role-cmdlets.md)**
...
**[Cmdlets Bureau d’enregistrement et directeurs dans Lync Server 2013](lync-server-2013-registrar-and-director-cmdlets.md)**
...
**[Cmdlets services dans Lync Server 2013](lync-server-2013-services-cmdlets.md)**
...
**[Résoudre les problèmes liés aux rôles de serveur et aux applets de service dans Lync Server 2013](lync-server-2013-troubleshooting-server-roles-and-services-cmdlets.md)**
...
**[Cmdlets Server et services Web dans Lync Server 2013](lync-server-2013-web-server-and-services-cmdlets.md)**

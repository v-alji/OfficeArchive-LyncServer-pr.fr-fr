...
6.  Dans **Créer une règle de normalisation**, entrez les valeurs dans les champs suivants :
      ...
      - **Chiffres de début**   (Facultatif) Spécifiez les chiffres de début des numéros composés que le modèle doit suivre. Par exemple, tapez **425** si vous souhaitez que le modèle suive les numéros composés commençant par 425.
      ...
      - **Chiffres à supprimer**   (Facultatif) Spécifiez le nombre de chiffres de début à supprimer des numéros composés que le modèle doit suivre.
    
      - **Chiffres à ajouter**   (Facultatif) Spécifiez les chiffres à ajouter aux numéros composés que le modèle doit suivre.
...
7.  Dans **Règle de conversion**, spécifiez comme suit le modèle du format des numéros de téléphone E.164 convertis :
    ...
    Par exemple, si le modèle **à faire correspondre** contient **^ ( \\ d {7} ) $** en tant que modèle pour les numéros numérotés et la **règle de traduction** contenant **+ 1425 $1** comme modèle pour les numéros de téléphone E. 164, la règle normalise 5550100 à + 14255550100.

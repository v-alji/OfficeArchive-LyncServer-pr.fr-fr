...
Vous pouvez supprimer des comptes d’utilisateurs à l’aide de l’applet de dialogue Disable-CsUser. Cette applet de commande peut être exécutée à partir de Lync Server 2013 Management Shell ou d’une session distante Windows PowerShell. Pour plus d’informations sur l’utilisation de Windows PowerShell distant pour vous connecter à Lync Server, voir l’article de blog Lync Server Windows PowerShell « démarrage rapide : gestion de Microsoft Lync Server 2010 à l’aide de Remote PowerShell » [https://go.microsoft.com/fwlink/p/?linkId=255876](https://go.microsoft.com/fwlink/p/?linkid=255876) .

<div>

## <a name="to-remove-a-user-account"></a>Pour supprimer un compte d’utilisateur

  - Pour supprimer un compte d’utilisateur, utilisez l’applet de Disable-CsUser cmdlet. Par exemple :
    
        Disable-CsUser -Identity "Ken Myer"
    
    Après avoir exécuté cette commande, il est impossible de réactiver le compte et ses paramètres précédents. À la place, vous devez utiliser l’applet de applet de Enable-CsUser pour créer un compte de marque pour Ken Myer.

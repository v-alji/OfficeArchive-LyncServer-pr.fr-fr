...
---
# <a name="msmqprocessing-table-in-lync-server-2013"></a>Table MSMQProcessing dans Lync Server 2013
...
La table MSMQProcessing est réservée à un usage interne. Ce tableau a été présenté dans Microsoft Lync Server 2013.

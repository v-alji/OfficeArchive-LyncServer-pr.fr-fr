...
---
# <a name="planning-for-branch-site-voice-resiliency-in-lync-server-2013"></a>Planification de la résistance vocale d’un site de succursale dans Lync Server 2013
...
Si vous souhaitez fournir une résilience de site de succursale, c’est-à-dire, un service voix entreprise haute disponibilité, trois options s’offrent à vous :
  ...
  - Déploiement complet de Lync Server sur le site de succursale

...
---
# <a name="delete-an-existing-client-version-policy-rule-in-lync-server-2013"></a>Supprimer une règle de stratégie de version de client existante dans Lync Server 2013

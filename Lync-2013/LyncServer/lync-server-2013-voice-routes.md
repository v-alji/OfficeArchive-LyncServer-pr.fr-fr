...
Lync Server 2013, à l’instar de ses prédécesseurs, nécessite que toutes les chaînes de numérotation soient normalisées au format E. 164 pour pouvoir exécuter la recherche de numéros inverse (RNL). S’il s’agit de circuits avec des passerelles ou des échangeurs de succursales privées qui nécessitent des numéros traduits dans les formats de numérotation locaux, Lync Server 2013 vous permet de créer une ou plusieurs règles qui vous aident à manipuler le numéro appelé (par exemple, l’URI de la demande) avant de le diriger vers le Trunk. Par exemple, vous pouvez rédiger une règle pour supprimer la valeur « +44 » au début de la chaîne de numérotation et la remplacer par « 0144 ».

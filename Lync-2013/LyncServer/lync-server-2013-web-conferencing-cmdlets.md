...
---
# <a name="web-conferencing-cmdlets-in-lync-server-2013"></a>Cmdlets de conférences Web dans Lync Server 2013
...
Les conférences et les réunions en ligne sont des éléments importants dans Microsoft Lync Server 2013. Les applets de CsConferencingConfiguration et CsConferencingPolicy sont les principaux outils d’administration de la gestion des conférences à l’aide de Windows PowerShell.

<div>

## <a name="web-conferencing-cmdlets"></a>Cmdlets de conférences Web

Les applets de [CsClientPolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15)) et [Set-CsClientPolicy](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) fournissent des méthodes supplémentaires pour configurer et gérer Lync Server 2013.

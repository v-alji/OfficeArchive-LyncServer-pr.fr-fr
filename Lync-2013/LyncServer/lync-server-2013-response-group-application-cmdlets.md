...
description: 'Lync Server 2013 : cmdlets application de Response Group.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
Response Group application est une fonctionnalité de gestion des appels voix entreprise qui achemine les appels entrants vers des groupes d’agents.

...
---
# <a name="configure-announcements-in-lync-server-2013"></a>Configurer des annonces dans Lync Server 2013
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Supprimer une annonce dans Lync Server 2013](lync-server-2013-delete-an-announcement.md)

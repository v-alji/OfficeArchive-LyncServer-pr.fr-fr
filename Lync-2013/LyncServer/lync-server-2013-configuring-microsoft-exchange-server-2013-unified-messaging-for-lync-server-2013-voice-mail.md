...
Après avoir configuré le serveur de messagerie unifiée, vous devez exécuter l’applet de nouvelle Enable-ExchangeCertificate pour vous assurer que votre certificat Exchange est appliqué au service de messagerie unifiée :

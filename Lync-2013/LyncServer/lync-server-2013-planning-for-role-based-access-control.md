...
<td><p>CSViewOnlyAdministrator</p></td>
<td><p>Gestion de l’organisation View-Only</p></td>
</tr>
<tr class="even">
...
Les applets de commande suivantes constituent un exemple de création d’un nouveau rôle. Ils créent un nouveau type de rôle appelé `MyHelpDeskScriptRole` . Le nouveau rôle est doté des capacités du rôle CsHelpDesk prédéfini et peut également exécuter les fonctions dans un script appelé « TestScript ».

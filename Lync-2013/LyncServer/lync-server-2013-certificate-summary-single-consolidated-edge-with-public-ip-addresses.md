...
## <a name="certificates-required-for-single-consolidated-edge-with-public-ip-addresses"></a>Certificats requis pour une seule périphérie consolidée avec des adresses IP publiques

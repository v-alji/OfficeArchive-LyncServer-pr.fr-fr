...
Effectuez une analyse hebdomadaire des journaux et des performances de Internet Information Services (IIS). Pour plus d’informations sur la façon de surveiller les journaux et performances d’IIS, voir [vue d’ensemble de la journalisation des événements Windows Server 2003 Internet Information Services (IIS)](https://go.microsoft.com/fwlink/?linkid=36077). L’avis doit inclure ce qui suit :
...
Assurez-vous que la RTCBPA.msi est installée sur tous les serveurs Lync Server 2013 et génère un rapport de vérification d’état hebdomadaire. Notez les résultats et l’exactitude, si nécessaire.
...
La documentation relative à cet outil est disponible dans [la documentation des outils du kit de ressources de Lync Server 2013](https://go.microsoft.com/fwlink/?linkid=623245).

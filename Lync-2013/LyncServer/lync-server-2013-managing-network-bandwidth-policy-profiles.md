...
---
# <a name="managing-network-bandwidth-policy-profiles-in-lync-server-2013"></a>Gestion des profils de stratégie de bande passante réseau dans Lync Server 2013
